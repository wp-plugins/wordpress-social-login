<div style="margin-left:20px;"> 
	...
	<div style="background-color: #FFFFE0;border:1px solid #E6DB55; border-radius: 3px;padding: 0px;">
		<p style="margin-left:20px;">
			Keep in mind I'm a busy man and providing customer support is not my cup of tea.
		</p>
		<p style="margin-left:20px;">
			If i did not answer your question or it took too long to, then its either :
		</p>
		<ul style="margin-left:40px;">
			<li>I didn't understand it,</li>
			<li>It has been asked before on the google group or wordpress forum,</li>
			<li>Your "question" is too stupid,</li>
			<li>I'm simply too busy or hibernating irl,</li>
			<li>also, questions containing hi, hello and thank you can make a diffrence :P.</li>
		</ul> 
	</div>  
</div>
