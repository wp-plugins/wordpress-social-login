		...
		<div class="inside"> 
			...
			<p>
				...
				<ul style="margin-left:40px;margin-top:0px;">
					...
					<li><b>WSL</b> will try to import as much information about a user contacts as he was able to pull from the social networks APIs. (eg: Only <b>Google</b> provide the contacts emails)</li> 
					<li>All contacts are sotred by <b>WSL</b> into your database on table: <code><?php echo "`{$wpdb->prefix}wsluserscontacts`" ?></code>.</li> 
				</ul> 
			</p> 
		</div>
	</div>
